...
namespace PokerCash.Auth.Identity
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            //    .WriteTo.File("PokerCash.AuthIdentity-.txt", rollingInterval:
            //        RollingInterval.Day)
            //    .CreateLogger();
            ...
            using(var scope = host.Services.CreateScope())
            {
                ...
                try
                {
                    ...
                    var context = serviceProvider.GetRequiredService<PokerCashAuthDbContext>();
        ...
        public static IHostBuilder CreateHostBuilder(string[] args) =>
            Host.CreateDefaultBuilder(args)
                .UseSerilog((context, configuration) => configuration
                        ...
                        .WriteTo.File("PokerCashAuthIdentity-.txt", rollingInterval:
                            RollingInterval.Day)
                        .WriteTo.Console(),
